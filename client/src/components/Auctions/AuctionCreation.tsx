...
interface ImageUploadProps {
    ...
    setArticle: (article: ArticleCreation) => void;
}
...
function AuctionCreation() {
    ...
    const [articleBeginDate, setArticleBeginDate] = useState<Date>(article.beginDate);
    const [articleEndDate, setArticleEndDate] = useState<Date>(article.endDate);

    const onSubmit = async (_event: MouseEventHandler<HTMLButtonElement>) => {
    ...
    return (
        <div className="flex flex-row">
            <div className="flex flex-col w-1/3">"begin :"
                <div className="max-w-sm mx-auto bg-white rounded-lg shadow-md overflow-hidden items-center">
                    <div className="px-4 py-6">
                        <ImageUpload article={article} setArticle={setArticle}/>
                    </div>
                </div>
            </div>
            <div className="flex flex-col w-96">
                <form>
                    ...
                    <div className="relative max-w-xs">
                        ...
                        <div
                            className="absolute my-2 inset-y-0 start-0 flex items-center ps-3 pointer-events-none"></div>
                        <Datepicker setArticleBeginDate={setArticleBeginDate}/>
                    </div>
                    ...
                    <div className="relative max-w-xs">
                        ...
                        <div
                            className="absolute my-2 inset-y-0 start-0 flex items-center ps-3 pointer-events-none"></div>
                        <Datepicker setArticleEndDate={setArticleEndDate}/>
