        ...
        <div
            ...
            {file ? (
                ...
                <label htmlFor="upload" className="cursor-pointer flex flex-col items-center">
                    ...
                    <p className="font-normal text-sm text-gray-400 md:px-6">Choose photo size should be less than <b
                        className="text-gray-600">2mb</b></p>
                    <p className="font-normal text-sm text-gray-400 md:px-6">and should be in <b
                        className="text-gray-600">JPG, PNG,
                        or GIF</b> format.</p>
                    ...
                    <input id="upload" type="file" className="hidden" accept="image/*" value={file!}
